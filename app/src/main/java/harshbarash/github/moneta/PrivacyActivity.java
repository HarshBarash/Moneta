...
public class PrivacyActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener  {
    ...
    String[] status = {"Открытый аккаунт","Закрытый аккаунт"};
    ...
    public void onNothingSelected(AdapterView<?> adapterView) {
        ...
        Toast.makeText(this, "Пожалуйста выберите значение", Toast.LENGTH_SHORT).show();
    }
        ...
        reference.get()
                .addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                   ...
                   if (task.getResult().exists()){
                       ...
                       Toast.makeText(PrivacyActivity.this, "Что-то пошло не так", Toast.LENGTH_SHORT).show();
                   }
        ...
        final  String value = spinner.getSelectedItem().toString();
            ...
            db.runTransaction(new Transaction.Function<Void>() {
                ...
                public void onSuccess(Void aVoid) {
                    Toast.makeText(PrivacyActivity.this, "Обновлено", Toast.LENGTH_SHORT).show();
                }
            })
