...
//Класс, который инкапсулирует утомительные фрагменты рендеринга разборчивого текста с рамками на холсте.
public class BorderedText {
  ...
  /**
   Создает выровненный по левому краю текстовый объект с белой внутренней частью и черной внешней частью с
   * заданный размер текста.
   *
  ...
  /**
   * Создайте текстовый объект с рамками с заданными внутренними и внешними цветами, размером текста и
   * выравнивание.
   *
